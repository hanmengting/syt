<template>
    <div class="tip">
        ...
        <div class="deparment">
            <div class="header">
                <div class="left">
                    <svg t="1711007328569" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="6477" width="16" height="16">
                        <path
                        ...
                        <path
                            ...
                            fill="#1296db" p-id="6483"></path>
                    </svg>
                    <span>常见科室</span>
                </div>
                <div class="right">
                    <span>全部</span>
                    <svg t="1711007215503" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="5354" width="16" height="16">
                        <path
        ...
        <div class="notice">
            <div class="header">
                <div class="left">
                    <svg t="1711022001729" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="4272" width="16" height="16">
                        <path
